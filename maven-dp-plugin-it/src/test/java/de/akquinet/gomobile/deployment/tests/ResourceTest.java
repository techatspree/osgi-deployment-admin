...
public class ResourceTest {
    ...
    File testDir = new File("src/test/resources/resource");
    ...
    public void setUp() throws VerificationException, IOException {
        ...
        verifier.deleteArtifact( Helper.TEST_GROUP_ID, "test-resource", Helper.TEST_VERSION, "dp" );
    ...
    public void testPackage() throws IOException, VerificationException {
        ...
        // Check existency
        File result = new File(testDir + "/target/test-resource-0.0.1-SNAPSHOT.dp"); // Expected name
        ...
        JarEntry je2 = jar.getJarEntry("pax-web.xml");
        ...
        Assert.assertEquals("de.akquinet.gomobile.deployment.test.resource", sn);
        ...
        section = manifest.getAttributes("pax-web.xml");
