...
public class SimpleTest {
    ...
    File testDir = new File("src/test/resources/simple");
    ...
    public void setUp() throws VerificationException, IOException {
        ...
        verifier.deleteArtifact( Helper.TEST_GROUP_ID, "test-simple", Helper.TEST_VERSION, "dp" );
    ...
    public void testPackage() throws IOException, VerificationException {
        ...
        // Check existency
        File result = new File(testDir + "/target/test-simple-0.0.1-SNAPSHOT.dp"); // Expected name
        ...
        Assert.assertEquals("de.akquinet.gomobile.deployment.test.simple", sn);
