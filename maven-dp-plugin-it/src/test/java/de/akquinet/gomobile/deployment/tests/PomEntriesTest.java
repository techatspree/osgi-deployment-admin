...
public class PomEntriesTest {

    File testDir = new File("src/test/resources/pom-entries");
    ...
    public void setUp() throws VerificationException, IOException {
        ...
        verifier.deleteArtifact( Helper.TEST_GROUP_ID, "test-pom-entries", Helper.TEST_VERSION, "dp" );
    ...
    public void testPackage() throws IOException, VerificationException {
        ...
        // Check existency
        File result = new File(testDir + "/target/test-pom-entries-0.0.1-SNAPSHOT.dp"); // Expected name
