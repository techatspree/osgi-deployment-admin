...
public class MixTest {
    ...
    File testDir = new File("src/test/resources/mix");
    ...
    public void setUp() throws VerificationException, IOException {
        ...
        verifier.deleteArtifact( Helper.TEST_GROUP_ID, "test-mix", Helper.TEST_VERSION, "dp" );
    ...
    public void testPackage() throws IOException, VerificationException {
        ...
        // Check existency
        File result = new File(testDir + "/target/test-mix-0.0.1-SNAPSHOT.dp"); // Expected name
        ...
        JarEntry je2 = jar.getJarEntry("resources/pax-web.xml");
        Assert.assertNotNull(je2);

        JarEntry je3 = jar.getJarEntry("bundles/org.apache.felix.log-1.0.0.jar");
        Assert.assertNotNull(je3);
        ...
        Assert.assertEquals("de.akquinet.gomobile.deployment.test.mix", sn);
        ...
        section = manifest.getAttributes("resources/pax-web.xml");
        String rp = section.getValue("Resource-Processor");

        Assert.assertEquals("org.osgi.deployment.rp.autoconf", rp);
