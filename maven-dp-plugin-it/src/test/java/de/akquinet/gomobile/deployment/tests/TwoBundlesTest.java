...
public class TwoBundlesTest {

    File testDir = new File("src/test/resources/two-bundles");
    ...
    public void setUp() throws VerificationException, IOException {
        ...
        verifier.deleteArtifact( Helper.TEST_GROUP_ID, "test-two-bundles", Helper.TEST_VERSION, "dp" );
    ...
    public void testPackage() throws IOException, VerificationException {
        ...
        // Check existency
        File result = new File(testDir + "/target/test-two-bundles-0.0.1-SNAPSHOT.dp"); // Expected name
        ...
        Assert.assertEquals("de.akquinet.gomobile.deployment.test.two-bundles", sn);
