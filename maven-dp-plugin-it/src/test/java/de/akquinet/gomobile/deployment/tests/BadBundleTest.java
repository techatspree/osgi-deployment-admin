...
public class BadBundleTest {

    File testDir = new File("src/test/resources/bad-bundle");
    ...
    public void setUp() throws VerificationException, IOException {
        ...
        verifier.deleteArtifact( Helper.TEST_GROUP_ID, "test-bad-bundle", Helper.TEST_VERSION, "dp" );
