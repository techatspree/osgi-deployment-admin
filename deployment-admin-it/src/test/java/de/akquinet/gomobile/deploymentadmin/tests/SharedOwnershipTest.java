...
public class SharedOwnershipTest extends Helper {
    ...
    public static Option[] configure() throws Exception {
        ...
        String dp2 = createDPWithTheSameBundle().toExternalForm();
           ...
           Option[] opt =  options(
                   ...
                   systemProperty("de.akquinet.gomobile.deployment.sharedOwnership").value("true"),
                   Helper.getDPBundles()
                   );
           return opt;
       }
    ...
    @Test
    public void checkSharedOwnershipBehavior() throws DeploymentException, IOException {
        ...
        // Bundle Repository not uninstalled.
        b1 = getBundleByName(context, "org.apache.felix.log");
        Assert.assertNotNull(b1);
    ...
    public static URL createDPWithTheSameBundle() throws Exception {
        ...
        dp
        	.addBundle(BUNDLE1, "bundle/b1.jar")
        	.setSymbolicName("my.first2.dp")
        	.setVersion("1.0.0")
        	.addBundle(BUNDLE2);
